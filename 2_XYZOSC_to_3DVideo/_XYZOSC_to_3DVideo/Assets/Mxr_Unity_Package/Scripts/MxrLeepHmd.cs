...
public class MxrLeepHmd : MonoBehaviour {
	...
	void Start () {
		...
		if (isStereo)
		{
            this.cameraLeft.GetComponent<Camera>().nearClipPlane = this.nearClipPlane;
            this.cameraLeft.GetComponent<Camera>().farClipPlane = this.farClipPlane;
            this.cameraRight.GetComponent<Camera>().nearClipPlane = this.nearClipPlane;
            this.cameraRight.GetComponent<Camera>().farClipPlane = this.farClipPlane;
		}
		else
		{
            this.cameraMono.GetComponent<Camera>().nearClipPlane = this.nearClipPlane;
            this.cameraMono.GetComponent<Camera>().farClipPlane = this.farClipPlane;
		}
	}
